...
class PagesController extends Controller
{
    ...
    public function track(Request $request)
    {
        ...
        return view("Frontend.Page.track", compact('order', 'orders'));
    }
    public function about_us()
    {
        ...
        return view("Frontend.Page.aboutUs", compact('about'));
    }
    ...
    public function trams()
    {
        ...
        return view("Frontend.Page.tramsCondition", compact('page'));
    }
