...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('slide') }}">Brand</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- form start -->
            {!! Form::model($brand, ['method'=>'PATCH','route'=>['madmin.brands.update', $brand->id],'class'=>'form-horizontal', 'files'=>true]) !!}
            <div class="row">
                <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        {!! Form::label('name', 'Brand Title', ['class' => 'col-sm-12 col-form-label']) !!}
                                        <div class="col-sm-12">
