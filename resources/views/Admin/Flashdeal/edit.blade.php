        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- form start -->
                        {!! Form::model($flash, ['method'=>'PATCH','route'=>['madmin.flashdealadmin.update', $flash->id],'class'=>'form-horizontal', 'files'=>true]) !!}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                {!! Form::label('name', 'Start Date', ['class' => 'col-sm-3 col-form-label']) !!}
                                <div class="col-sm-9">
                                    {!! Form::text('start_date1', date('d/m/Y H:m',$flash->start_date), ['class'=>'form-control','id'=>'reservationtime','required']) !!}
                                </div>
                            </div>

                            <div class="form-group row">
                                {!! Form::label('name', 'End Date', ['class' => 'col-sm-3 col-form-label']) !!}
                                <div class="col-sm-9">
                                    {!! Form::text('end_date1', null, ['class'=>'form-control','id'=>'reservationtime1','required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::text('background_color', null, ['class'=>'form-control my-colorpicker1 colorpicker-element','required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::text('text_color', null, ['class'=>'form-control my-colorpicker2 colorpicker-element','required']) !!}
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    @foreach($product_ids as $id)
                                        <div class="row product_inc" style="margin-bottom:10px;">
                                            <div class="col-md-8">
                                                {!! Form::text('product_id[]', $id->product->title, ['class'=>'form-control product_id','id'=>'receiver','required']) !!}
                                            </div>
...
<script type="text/javascript">
    ...
    $('#reservationtime').daterangepicker({
        ...
        "startDate": "{{ date('mm/dd/Y H:m',$flash->start_date) }}",
        "endDate": "10/19/2021"
    ...
    $('#reservationtime1').daterangepicker({
        ...
        "alwaysShowCalendars": true,
        "startDate": "{{ date('mm/dd/Y H:m',$flash->end_date) }}",
        "endDate": "10/19/2021"
    }, function(start, end, label) {
        console.log('New date range selected: ' + start.format('YYYY-MM-DD HH:mm') + ' to ' + end.format('YYYY-MM-DD HH:mm') + ' (predefined range: ' + label + ')');
    });
