...
@section('content')
    ...
    @include('Admin.include.breadcrumb', [
        ...
        'parent' => __('Home'),
        'child' => __('Products'),
        'button' => __('Product List'),
        'button_icon' => 'lni-text-align-justify',
        'route' => route('madmin.products.index'),
    ])
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        {!! Form::number('qty', 1, ['class' => 'form-control', 'id' => 'receiver', 'required']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        {!! Form::number('regular_price', 0, ['class' => 'form-control', 'id' => 'receiver']) !!}
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        {!! Form::select('featured', ['No' => 'No', 'Yes' => 'Yes'], null, [
                                                            'class' => 'form-control',
                                                            'id' => 'receiver',
                                                        ]) !!}
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    @foreach ($attributes as $attribute)
                                                        @php
                                                            $atts = \App\Models\Atribute::where(
                                                                'parent_id',
                                                                $attribute->id,
                                                            )->get();
                                                        @endphp
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                @foreach ($atts as $color)
                                                                    <label>{!! Form::checkbox($attribute->value . '[]', "$color->id", null, ['class' => '', 'id' => 'receiver']) !!}
                                                                        {{ $color->name }}&nbsp; </label>
                                                                @endforeach
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" id="tag1" class="form-control"
                                                            name="tag" />
                                                        {{-- {!! Form::text('tag', null, ['class' => 'form-control', 'id' => 'tag1']) !!} --}}
                                ...
                                <div class="card card-info">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::select('category_id', ['0' => 'Select Category'] + $parents, null, [
                                                    'class' => 'form-control',
                                                    'id' => 'parent_cat',
                                                    'required',
                                                ]) !!}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::select('sub_category_id', ['0' => 'Sub Category'] + $sub_cats, null, [
                                                    'class' => 'form-control',
                                                    'id' => 'sub_cat',
                                                ]) !!}
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::select('brand_id', ['0' => 'Select Brand'] + $brands, null, [
                                                    'class' => 'form-control',
                                                    'id' => 'receiver',
                                                ]) !!}
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <img id="preview-image-before-upload"
                                                    src="{{ asset('public') }}/admin/notfindproduct.png" style="width: 100%"
                                                    class="img-thumbnail">
                                                {!! Form::file('images', ['class' => 'form-control-file', 'id' => 'image', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(responce) {
                    ...
                    for (var i = 0; i < responce.length; i++) {
                        ...
                        $("#sub_cat").append("<option value=" + responce[i].id + ">" + responce[i]
                            .title + "</option>");
                    }
                }
            });
