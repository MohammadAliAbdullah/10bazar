...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            {!! Form::open(['method'=>'POST','route'=>'madmin.products.store','class'=>'form-horizontal', 'files'=>true]) !!}
            <div class="row">
                <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            @foreach($atts as $color)
                                                <label>{!! Form::checkbox($attribute->value.'[]',"$color->id",null,['class'=>'','id'=>'receiver']); !!} {{ $color->name }}&nbsp; </label>
                                            @endforeach
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" id="tag1" class="form-control" name="tag"  />
                                        </div>
                                    </div>
                                    <div class="form-group row">
