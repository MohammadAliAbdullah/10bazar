        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    {!! Form::model($product, [
                        'method' => 'PATCH',
                        'route' => ['madmin.products.update', $product->id],
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            @foreach ($atts as $color)
                                                                <label>{!! Form::checkbox($attribute->value . 'd[]', "$color->id", null, [
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    @php
                                                        $tags = \App\Models\ProductTag::where(
                                                            'product_id',
                                                            $product->id,
                                                        )
                                                    ...
                                                    <input type="text" id="tag1"
                                                        value="{{ implode(',', $arra ?? '') }}" class="form-control"
                                                        name="tag" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            @if ($product->images)
                                                <img id="preview-image-before-upload" src="{{ asset($product->images) }}"
