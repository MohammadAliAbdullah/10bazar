        ...
        <div class="container-fluid">
            ...
            'phone' => 'Phone',
                    ...
                    <div class="tab-pane fade" id="invoice">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {!! Form::text('invoice_company', old('invoice_company', $setting->invoice_company ?? ''), [
                                    'class' => 'form-control',
                                ]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {!! Form::email('invoice_email', old('invoice_email', $setting->invoice_email ?? ''), [
                                    'class' => 'form-control',
                                ]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {!! Form::file('invoice_logo', [
                                    'class' => 'form-control',
                                    'onchange' => "previewImage(this, 'invoiceLogoPreview')",
                                ]) !!}
                                ...
                                <select name="currency_id" id="currency_id" class="form-control">
                                    @foreach ($currencies as $currency)
                                        <option value="{{ $currency->id }}"
                                            {{ old('currency_id', $setting->currency_id ?? '') == $currency->id ? 'selected' : '' }}>
                                            {{ $currency->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea(
                                    ...
                                    old('google_map_embed_link', $setting->google_map_embed_link ?? ''),
                                    ['class' => 'form-control'],
                                ) !!}
                            </div>
                        </div>
            ...
            'footer_text' => 'Footer Text',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {!! Form::textarea('powered_by_text', old('powered_by_text', $setting->powered_by_text ?? ''), [
                                    'class' => 'form-control',
                                ]) !!}
                            </div>
                        </div>
