        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- form start -->
                        {!! Form::open(['method'=>'POST','route'=>'madmin.discounts.store','class'=>'col-sm-10 form-horizontal', 'files'=>true]) !!}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                {!! Form::label('name', 'Amount', ['class' => 'col-sm-4 col-form-label']) !!}
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                {!! Form::label('name', 'Limit', ['class' => 'col-sm-4 col-form-label']) !!}
                                <div class="col-sm-8">
