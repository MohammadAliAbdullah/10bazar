                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($discounts as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                    <a href="{{route('madmin.discounts.show',$value->id)}}" class="btn btn-success m-1"><i class="lni-eye"></i> </a>
                                                    <a href="{{route('madmin.discounts.edit',$value->id)}}" class="btn btn-success m-1"><i class="lni-pencil-alt"></i> </a>
