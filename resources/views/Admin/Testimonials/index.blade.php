...
@section('content')
    @include('Admin.include.breadcrumb', [
        'page' => __('Testimonial'),
        'parent' => __('Home'),
        'child' => __('Testimonial'),
        'route' => route('madmin.testimonials.create'),
    ])
    ...
    {{-- <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Testimonial
                        <a href="{{ route('madmin.testimonials.create') }}" class="btn btn-primary"> Add</a>
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($testimonials as $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->title }}</td>
                                        <td>
                                            <img src="{{ asset('storage/admin/images/testimonials/'.$value->image) }}" width="80" height="60">
                                        </td>
                                        <td>{{ $value->status }}</td>
