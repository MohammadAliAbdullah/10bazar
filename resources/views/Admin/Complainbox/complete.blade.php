...
@section('content')
    @include('Admin.include.breadcrumb', [
        'page' => __('Complain Box Complete'),
        'parent' => __('Home'),
        'child' => __('Complain Box'),
        'route' => route('madmin.complainadmin.index'),
    ])
    ...
    {{-- <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Complain Box Complete
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Complain Box Complete</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
