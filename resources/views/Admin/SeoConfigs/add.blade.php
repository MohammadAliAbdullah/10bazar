...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Add SEO Config</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('slide') }}">SEO Config</a></li>
                        <li class="breadcrumb-item active">Add SEO Config</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <!-- form start -->
                        {!! Form::open(['method'=>'POST','route'=>'madmin.seoconfigs.store','class'=>'form-horizontal', 'files'=>true]) !!}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('meta_description', null, ['class'=>'form-control','id'=>'receiver','required', 'rows' =>3]) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <p>Get your google analytics verification code at <a href="https://analytics.google.com/analytics/web/">Google anylitics</a></p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <p>Get your facebook verification link at <a href="#">facebook</a></p>
                                </div>
                            </div>
