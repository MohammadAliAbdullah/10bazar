            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <!-- form start -->
                        {!! Form::open(['method'=>'POST','route'=>'madmin.local-sale.store','class'=>'form-horizontal', 'files'=>true]) !!}
                        <div class="card-body">
                            <table class="table">
                              <thead>
                                <tr>
                              ...
                              <tbody>
                                <tr class='main_row'>
                                  <th><input class="item" id="item" type="text" name="item[]"></th>
                                  <td>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                   <div class="left-info">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <input class="input_left" id="invoice" type="text" name="invoice" value="{{$invoice}}">
                                        </div>

                                        <div class="form-group form-inline">
                                            <label for="challan_no" class="small">Challan</label>&nbsp;
                                            <input class=" input_left" id="challan_no" type="text" name="challan_no" value="{{$challan_number}}">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="right-info">
                                        ...
                                        <input class="input_left" id="sub_total" type="text" name="sub_total">
                                    </div>

                                    <div class="form-group form-inline">
                                        <label for="discount" class="small">Discount</label>&nbsp;
                                        <input class="input_left" id="discount" value="0" type="text" name="discount">
                                    </div>

                                    <div class="form-group form-inline">
                                        <label for="vat" class="small">VAT (%)</label>&nbsp;
                                        <input class="input_left" id="vat" value="0" type="text" name="vat">
                                    </div>

                                    <div class="form-group form-inline">
                                        <label for="delivery_charge" class="small">Delivery Charge</label>&nbsp;
                                        <input class=" input_left" id="delivery_charge" value="0" type="text" name="delivery_charge">
                                    </div>

                                    <div class="form-group form-inline">
                                        <label for="grand_total" class="small">Grand Total</label>&nbsp;
                                        <input class="input_left" id="grand_total" value="0" type="text" name="grand_total">
                                    </div>
