...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit SMS Templete</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/smstemplete') }}">SMS Templete</a></li>
                        <li class="breadcrumb-item active">Edit SMS Templete</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <!-- form start -->
                        {!! Form::model($value, ['method'=>'PATCH','route'=>['smstemplete.update',$value->id],'class'=>'form-horizontal', 'files'=>true]) !!}
                        <div class="card-body">
