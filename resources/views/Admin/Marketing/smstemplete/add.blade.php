...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Add SMS Templete</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('smstemplete.index') }}">SMS Templete</a></li>
                        <li class="breadcrumb-item active">Add SMS Templete</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <!-- form start -->
                        {!! Form::open(['method'=>'POST','route'=>'smstemplete.store','class'=>'form-horizontal']) !!}
                        <div class="card-body">
