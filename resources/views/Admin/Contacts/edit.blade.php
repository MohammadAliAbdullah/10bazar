            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('slide') }}">Contact</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- form start -->
                        {!! Form::model($info, ['method'=>'PATCH','route'=>['madmin.contacts.update', $info],'class'=>'form-horizontal', 'files'=>true]) !!}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::textarea('address', null, ['class'=>'form-control','id'=>'receiver','required']) !!}
                                </div>
                            </div>
