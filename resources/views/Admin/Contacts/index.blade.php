            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Contact
                        <a href="{{ route('madmin.contacts.create') }}" class="btn btn-primary">Contact Add</a>
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($info as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                    <a href="{{route('madmin.contacts.edit',$value->id)}}" class="btn btn-success m-1"><i class="lni-pencil-alt"></i> </a>
