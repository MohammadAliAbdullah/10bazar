...
@section('content')
    @include('Admin.include.breadcrumb', [
        ...
        'parent' => __('Home'),
        'child' => __('Category'),
        'button' => __('Category List'),
        'button_icon' => 'lni-text-align-justify ',
        'route' => route('madmin.categories.index'),
    ])
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($category, [
                        'method' => 'PATCH',
                        'route' => ['madmin.categories.update', $category->id],
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    {!! Form::select('parent_id', ['0' => 'Select Parent'] + $parents, null, [
                                                        'class' => 'form-control',
                                                        'id' => 'receiver',
                                                        'required',
                                                    ]) !!}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        {!! Form::select('follow', ['Yes' => 'Yes', 'No' => 'No'], null, [
                                                            'class' => 'form-control',
                                                            'id' => 'receiver',
                                                        ]) !!}
                                                    </div>
                            ...
                            <div class="card card-info">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            {!! Form::select('type', ['Regular' => 'Regular Category', 'Special' => 'Special Category'], null, [
                                                'class' => 'form-control',
                                                'id' => 'receiver',
                                                'required',
                                            ]) !!}
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            {!! Form::label('name', 'Image', ['class' => 'col-form-label']) !!} <a href="" data-toggle="tooltip"
                                                data-placement="top" title="This image show in top category feature image">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            {!! Form::label('name', 'Banner', ['class' => 'col-form-label']) !!}
                                            <a href="" data-toggle="tooltip" data-placement="top"
                                                title="This image show in category left side image">
                                                <i class="fa fa-info-circle"></i>
                                            </a>
                                        </div>
                                        <div class="col-sm-12">
                                            {!! Form::file('banner', ['class' => '', 'id' => 'receiver']) !!}
                                            <img src="{{ asset($category->banner ?? '') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <img src="{{ asset('public/images/') }}/{{ $category->background ?? '' }}"
                                                class="img-fluid" alt="">
                                        </div>
                                    </div>
