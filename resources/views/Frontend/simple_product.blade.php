            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="productdet zoom-option">
                        <img class="xzoom lazy" id="xzoom-default" src="{{ asset('public/assets/images/products/' . $product->images) }}" xoriginal="{{ asset('public/assets/images/products/' . $product->images) }}" />
                        <div class="owl-carousel xzoom-thumbs">
                            @if (!empty($gallery[0]))
                                @foreach ($gallery as $key => $img)
                                    <a href="{{ asset('public/assets/images/products/' . $img) }}">
