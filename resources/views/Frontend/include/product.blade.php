<div class="product-item">
    ...
    <div class="product-img position-relative overflow-hidden productsss">
        ...
        <div class="product-action">
            ...
            {!! Form::close() !!}
            <a class="btn btn-outline-dark btn-square viewProductDetails"
                data-url="{{ route('product_quick_view_details', ['id' => $product->slug]) }}"><i
            ...
            <div class="d-flex">
                <div class="sizes">
                    @foreach ($colors as $val)
                        ...
                        @endphp
                        <label class="color"
                            style="width: 20px; height: 20px; margin-left: 10px; border-radius: 50%;  background-position: center; background:{{ $atts->value }}"></label>
                    @endforeach
                </div>
            </div>
        @endif
