                ...
                <div class="container">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="site-footer__widget footer-contacts">
                                    ...
                                    <ul class="footer-contacts__contacts">
                                        <li><i class="footer-contacts__icon fas fa-globe-americas"></i> Road-1/A, Sector-7, Uttara</li>
                                        <li><i class="footer-contacts__icon far fa-envelope"></i> 10bazar@gmail.com
                                        </li>
                                        <li><i class="footer-contacts__icon fas fa-mobile-alt"></i> +880 17 200 85127</li>
                    ...
                    <div class="site-footer__bottom">
                        <div class="site-footer__copyright"><a target="_blank"
                                href="https://cootsoft.vercel.app">COOTSOFT</a></div>
                        <div class="site-footer__payments"><img src="{{ asset('public') }}/coot_assets/images/payments.png" alt=""></div>
                    </div>
                </div>
            </div>
        </footer>