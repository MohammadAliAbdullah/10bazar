...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('public') }}/molla/assets/images/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('public') }}/molla/assets/images/icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('public') }}/molla/assets/images/icons/favicon-16x16.png">
    <link rel="manifest" href="{{ asset('public') }}/molla/assets/images/icons/site.html">
    <link rel="mask-icon" href="{{ asset('public') }}/molla/assets/images/icons/safari-pinned-tab.svg" color="#666666">
    <link rel="shortcut icon" href="{{ asset('public') }}/molla/assets/images/icons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Molla">
    <meta name="application-name" content="Molla">
    <meta name="msapplication-TileColor" content="#cc9966">
    <meta name="msapplication-config" content="{{ asset('public') }}/molla/assets/images/icons/browserconfig.xml">
    <meta name="theme-color" content="#ffffff">
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{ asset('public') }}/molla/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('public') }}/molla/assets/css/plugins/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="{{ asset('public') }}/molla/assets/css/plugins/magnific-popup/magnific-popup.css">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{ asset('public') }}/molla/assets/css/style.css">
    <link rel="stylesheet" href="{{ asset('public') }}/molla/assets/css/skins/skin-demo-22.css">
    <link rel="stylesheet" href="{{ asset('public') }}/molla/assets/css/demos/demo-22.css">
</head>
<body>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/logo.png" alt="Molla Logo" width="130" height="30">
                        </a>
                    </div><!-- End .header-left -->
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{ asset('public') }}/molla/assets/images/products/cart/product-1.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{ asset('public') }}/molla/assets/images/products/cart/product-2.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner banner-overlay">
                                                                <a href="category.html" class="banner banner-menu">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-13/menu/banner-1.jpg" alt="Banner">
                                                                </a>
                                                ...
                                                <div class="megamenu" style="display: none;">
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner banner-overlay">
                                                                <a href="category.html" class="banner banner-menu">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-13/menu/banner-2.jpg" alt="Banner">
                                                                </a>
                                                            </div><!-- End .banner banner-overlay -->
                                                        </div><!-- End .col-md-4 -->
                                                    </div><!-- End .row -->
                                                    ...
                                                    <div class="menu-col">
                                                        ...
                                                        <div class="row menu-banners">
                                                            <div class="col-md-4">
                                                                <div class="banner">
                                                                    <a href="#">
                                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-13/menu/1.jpg" alt="image">
                                                                    </a>
                                                                </div><!-- End .banner -->
                                                            </div><!-- End .col-md-4 -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="banner">
                                                                    <a href="#">
                                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-13/menu/2.jpg" alt="image">
                                                                    </a>
                                                                </div><!-- End .banner -->
                                                            </div><!-- End .col-md-4 -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="banner">
                                                                    <a href="#">
                                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-13/menu/3.jpg" alt="image">
                                                                    </a>
                                                                </div><!-- End .banner -->
                                                            </div><!-- End .col-md-4 -->
                                                        </div><!-- End .row -->
                                                ...
                                                <div class="megamenu" style="display: none;">
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner banner-overlay">
                                                                <a href="category.html" class="banner banner-menu">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-13/menu/banner-3.jpg" alt="Banner">
                                                                </a>
                                                            </div><!-- End .banner banner-overlay -->
                                                        </div><!-- End .col-md-4 -->
                                                    </div><!-- End .row -->
                                                    ...
                                                    <div class="menu-col menu-brands">
                                                        <div class="row">
                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/brands/1.png" alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->

                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/brands/2.png" alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->

                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/brands/3.png" alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->

                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/brands/4.png" alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->

                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/brands/5.png" alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->

                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="{{ asset('public') }}/molla/assets/images/brands/6.png" alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->
                                                        </div><!-- End .row -->
                                                    </div><!-- End .menu-brands -->
                                    ...
                                    <li>
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="{{ asset('public') }}/molla/assets/images/menu/banner-1.jpg" alt="Banner">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html">
                                                            <img src="{{ asset('public') }}/molla/assets/images/demos/demo-19/menu/banner-2.jpg" alt="Banner">
                                                        </a>
                                                    </div><!-- End .banner -->
                                                </div><!-- End .col-md-6 -->
                                            </div><!-- End .row -->
        ...
        <main class="main">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="intro-slider-container mt-2">
                            <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" 
                                ...
                                <div class="intro-slide banner-lg" style="background-image: url({{ asset('public') }}/molla/assets/images/demos/demo-22/slider/slide-1.jpg);">
                                    <div class="intro">
                                        <div class="title">
                                            <a>deal of the day</a>
                                        </div>
                                ...
                                <div class="intro-slide banner-lg" style="background-image: url({{ asset('public') }}/molla/assets/images/demos/demo-22/slider/slide-2.jpg);">
                                    <div class="intro">
                                        <div class="title">
                                            <a>clearance</a>
                                        </div>
                    ...
                    <div class="col-lg-4 banner">
                        <div class="col-12" style="background-image: url({{ asset('public') }}/molla/assets/images/demos/demo-22/slider/banner-1.jpg)">
                            <div class="intro">
                                <div class="title">
                                    <h3>New arrivals</h3>
                                </div>
                        ...
                        <div class="col-12" style="background-image: url({{ asset('public') }}/molla/assets/images/demos/demo-22/slider/banner-2.jpg)">
                            <div class="intro">
                                <div class="title">
                                    <h2>outdoor</h2>
                                </div>
                        ...
                        <div class="col-12" style="background-image: url({{ asset('public') }}/molla/assets/images/demos/demo-22/slider/banner-3.jpg)">
                            <div class="intro">
                                <div  class="title">
            ...
            <div class="container text-center shop">
                ...
                <div class="owl-carousel mb-5 owl-simple" data-toggle="owl" 
                    ...
                    <a href="#" class="brand">
                        <img src="{{ asset('public') }}/molla/assets/images/brands/7.png" alt="Brand Name">
                    </a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="product-lg">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/featured/product-1.jpg" alt="Product image" class="product-image">
                                    </a>
                                    ...
                                    <div class="row products all">
                                        <div class="col-lg-4 col-6">
                                            <div class="product product-3 text-center">
                                                <figure class="product-media">
                                                    ...
                                                    <a href="product.html">
                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/featured/product-2.jpg" alt="Product image" class="product-image">
                                                    </a>
                                        ...
                                        <div class="col-lg-4 col-6">
                                            <div class="product product-3 text-center">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/featured/product-3.jpg" alt="Product image" class="product-image">
                                                    </a>
                                        ...
                                        <div class="col-lg-4 col-6">
                                            <div class="product product-3 text-center">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/featured/product-4.jpg" alt="Product image" class="product-image">
                                                    </a>
                                        ...
                                        <div class="col-lg-4 col-6">
                                            <div class="product product-3 text-center">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/featured/product-5.jpg" alt="Product image" class="product-image">
                                                    </a>
                                        ...
                                        <div class="col-lg-4 col-6">
                                            <div class="product product-3 text-center">
                                                <figure class="product-media">
                                                    <span class="product-label label-sale">Sale</span>
                                                    <a href="product.html">
                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/featured/product-6.jpg" alt="Product image" class="product-image">
                                                    </a>
                                        ...
                                        <div class="col-lg-4 col-6">
                                            <div class="product product-3 text-center">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/featured/product-7.jpg" alt="Product image" class="product-image">
                                                    </a>
            ...
            <div class="newsletter" style="background-image: url(assets/images/demos/demo-22/newsLetter/background.jpg);">
                <div class="container">
            ...
            <div class="container banner-container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 banner-lg">
                        <a href="category.html">
                            <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/banner/banner-1.jpg">
                        </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 banner-lg">
                        <a href="category.html">
                            <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/banner/banner-2.jpg">
                        </a>
                        <div class="banner-content">
                            <div class="title">
                ...
                <div class="row products">
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-1.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-2.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-3.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-4.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-5.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-6.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-7.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-8.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-9.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/products/product-10.jpg" alt="Product image" class="product-image">
                                </a>
            ...
            <div class="container bannerad">
                <div class="banner-lg"  style="background-image: url(assets/images/demos/demo-22/bannerad/background.jpg);">
                    <div class="price">
                ...
                <div class="owl-carousel owl-simple mb-4" data-toggle="owl" 
                    ...
                    <article class="entry">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/post/post-1.jpg" alt="image desc">
                            </a>
                    ...
                    <article class="entry">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/post/post-2.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                    ...
                    <article class="entry">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/post/post-3.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="{{ asset('public') }}/molla/assets/images/demos/demo-22/logo-footer.png" class="footer-logo" alt="Footer Logo" width="100" height="25">
            ...
            <div class="footer-bottom">
                <div class="container">
                    ...
                    <figure class="footer-payments">
                        <img src="{{ asset('public') }}/molla/assets/images/payments.png" alt="Payment methods" width="272" height="20">
    ...
    <div class="container newsletter-popup-container mfp-hide" id="newsletter-popup-form">
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{ asset('public') }}/molla/assets/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{{ asset('public') }}/molla/assets/images/popup/newsletter/img-1.jpg" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
 	...
 	<!-- Plugins JS File -->
    <script src="{{ asset('public') }}/molla/assets/js/jquery.min.js"></script>
    <script src="{{ asset('public') }}/molla/assets/js/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('public') }}/molla/assets/js/jquery.hoverIntent.min.js"></script>
    <script src="{{ asset('public') }}/molla/assets/js/jquery.waypoints.min.js"></script>
    <script src="{{ asset('public') }}/molla/assets/js/superfish.min.js"></script>
    <script src="{{ asset('public') }}/molla/assets/js/owl.carousel.min.js"></script>
    <script src="{{ asset('public') }}/molla/assets/js/bootstrap-input-spinner.js"></script>
    <script src="{{ asset('public') }}/molla/assets/js/jquery.magnific-popup.min.js"></script>
    <!-- Main JS File -->
