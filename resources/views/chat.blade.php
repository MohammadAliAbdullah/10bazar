    ...
    $('#send-btn').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                $('#messages').append(`<div class="msg bot"><strong>Bot:</strong> ${res.reply}</div>`);
                $('#messages').scrollTop($('#messages')[0].scrollHeight);
            },
            error: function () {
                $('#messages').append(`<div class="msg bot"><strong>Bot:</strong> Something went wrong. Please try again.</div>`);
            }
        });
    });
